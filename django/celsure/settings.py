"""
Django settings for celsure project.
...
SECRET_KEY = env.str("SECRET_KEY", "django-insecure-ln-qyn^eb&udld81nbc#^ljqcj5_u7dgazut7&5rp^rr$o&_3y")
...
WSGI_APPLICATION = "celsure.wsgi.application"
...
if env.str("DJANGO_LOGGING_JSONFILE", None):
    LOGGING = json.load(open(env.str("DJANGO_LOGGING_JSONFILE")))
